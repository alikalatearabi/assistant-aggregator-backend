...
export class MessagesController {
  ...
  async findAllMessages(@Query() query: MessageQueryDto) {
    return this.messagesService.findAllMessages(query);
  }
  ...
  async searchMessages(@Query('q') searchTerm: string): Promise<Message[]> {
    return this.messagesService.searchMessages(searchTerm);
  }

  @Get('positive')
  @ApiExcludeEndpoint()
  async findPositiveMessages(): Promise<Message[]> {
    return this.messagesService.findPositiveMessages();
  }

  @Get('negative')
  @ApiExcludeEndpoint()
  async findNegativeMessages(): Promise<Message[]> {
    return this.messagesService.findNegativeMessages();
  }

  @Get('neutral')
  @ApiExcludeEndpoint()
  async findNeutralMessages(): Promise<Message[]> {
    return this.messagesService.findNeutralMessages();
  }

  @Get('category/:category')
  @ApiExcludeEndpoint()
  async findMessagesByCategory(@Param('category') category: string): Promise<Message[]> {
    return this.messagesService.findMessagesByCategory(category);
  }
  ...
  async findMessagesByScoreRange(
    ...
    return this.messagesService.findMessagesByScoreRange(+minScore, +maxScore);
  }
